/*
Command spectra is a tool for creating a group of Amazon CloudFormation
files based on an environment manifest, base cloudformation template,
and a base CoreOS Userdata file.
...
See the example directory for examples on the cloudformation template
and CoreOS userdata.

As this tool was designed to automate creation of cloudformations for a
deploy of Deis, the examples and some things of that ilk will reference
Deis. This tool is distributed publicly in the hope that it will be useful
but the authors of this tool assume no responsibility for any resources it
creates.
