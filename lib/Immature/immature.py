phrases = [" in your pants", "... ladies", " in bed", " at night", " with your mother",
        "... that's what she said", " #420", " #swag", " #yolo", " LE MAYMAY",
        " so edgy", " #yoloswag"]
...
if __name__ == "__main__":
    testphrases = [
            "I am awesome.",
            "SO COOL DRAGONITE!",
            "check out my site! http://herp.derp",
            "OPERATION SIMPLISTIC SALTY GREAT GRAPE RAPE APE",
            "OPERATION EXPECT NO MERCY FROM OUR JUMBLED DISCOVERY",
            "OPERATION TWISTING ADAPTABLE BREATH",
    ]

    for phrase in testphrases:
        print phrase, "->", immature(phrase)
        if not compare(phrase):
            sys.exit(1)
