...
public class DomBoard {
    ...
    public double getRawAnalog(int channel) {
        return this.ds.getAnalogIn(channel);
    }

    public double getAnalog(int channel) {
        return NumberUtils.rangeConvert(this.getRawAnalog(channel), 0, 3.3, -1, 1);
    }

    public boolean getRawValue(int channel) {
        return this.ds.getDigitalIn(channel);
    }
}
