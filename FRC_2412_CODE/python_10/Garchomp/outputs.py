...
class Driver_2:
    ...
    def __init__(self, port1, port2):
        self.L = SpeedCon(port1, True)
        self.R = SpeedCon(port2, True)
    ...
    def arcadeDrive(self, stick):
        return self.arcadeDriveRaw(stick.getStickAxes()[0]/2, stick.getStickAxes()[1]/2)
...
class Driver_4:
    ...
    def __init__(self, port1, port2, port3, port4):
        ...
        self.FL = SpeedCon(port1, True)
        self.FR = SpeedCon(port2, True)
        self.RL = SpeedCon(port3, True)
        self.RR = SpeedCon(port4, True)
...
class SpeedCon:
    def __init__(self, port, jaguar):
        print("speedcon obj on port " + str(port) + " active")
