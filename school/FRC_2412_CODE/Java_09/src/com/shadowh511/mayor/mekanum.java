...
import com.shadowh511.mayor.util.*;
...
public class mekanum extends SimpleRobot {
    JessPad sideWing = new JessPad(1);  //xbox 360 controller
    ...
    public void autonomous() {
        ...
        int i = 4;
        while(i > 0) {
            robot.holonomicDrive(0.75, 0, 0);
            Timer.delay(1);
            robot.holonomicDrive(0, 0.75, 0);
            Timer.delay(1);
            robot.holonomicDrive(-0.75, 0, 0);
            Timer.delay(1);
            robot.holonomicDrive(0, -0.75, 0);
    ...
    public void operatorControl() {
        ...
        while(isEnabled()) {
            Q.feed();
            robot.holonomicDrive(sideWing);
            lcd.writeOnLine(0, ""+i, 0);
